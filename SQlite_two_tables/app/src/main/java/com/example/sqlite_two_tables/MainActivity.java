...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = db.query("position", null, null, null, null, null,
                null);
        logCursor(cursor);
        cursor.close();
        Log.d(TAG, "---- ----");
        ...
        cursor = db.query("people", null, null, null, null, null,
                null);
        logCursor(cursor);
        cursor.close();
        Log.d(TAG, "---- ----");

        Log.d(TAG, "INNER JOIN with rowQuery");
        ...
        Log.d(TAG, "INNER LOIN with query");
        String table = "people as PL inner loin position as PS on PL.posid = PS.id";
            ...
            if (cursor.moveToFirst()) {
                ...
                do {
                    ...
                    for (String cn : cursor.getColumnNames()) {
                        str = str.concat(cn + " = " + cursor.getColumnIndex(cn) + "; ");
                    }
                    Log.d(TAG, str);
